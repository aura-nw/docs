...
<DocCard>
  <p>
    You will learn the general structure of a CosmWasm contract.
  </p>
  <ul>
...
## Basic Example: Flower Store Contract
...
And that's it. In the next section we will show you how to deploy the Flower Store contract using the Aura CLI `aurad`.
