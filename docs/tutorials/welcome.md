...
<FeatureList>
  <Column title="Examples">
    <Feature url="/tutorials/examples/install" title="Install requirements" subtitle="How to setup developing environment" image="hello-near.png" />
    <Feature url="/tutorials/examples/hello-aura" title="Hello AURA" subtitle="A friendly app that stores a greeting" image="hello-near.png" />
